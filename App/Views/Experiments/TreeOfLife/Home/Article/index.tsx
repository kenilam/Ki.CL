  ...
  return (
    ...
    >
      <article className={`${CLASS_NAME}__article`}>
        ...
        <Text is='p'>
          Open Tree answers questions about subtrees. Ask it for a node and you
          get whatever hangs below that node, up to a height limit, which means
          the node you asked for arrives with no parent attached. Store that
          as-is and you’ve just recorded that a genus is the root of all life.
        </Text>
