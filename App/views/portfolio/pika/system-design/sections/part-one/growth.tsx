...
const Growth: React.FunctionComponent = () => (
  <>
    ...
    <Text>
      Manifests already make Apps no-code, so Growth needs tooling and
      guardrails around them. App Studio is an internal builder that edits
    ...
    <Text>
      Governance keeps self-serve safe: validation and a lightweight approval on
      publish, staged rollout with an automatic halt on error-rate or cost
      regression, one-click rollback via the version pointer, and per-App
      budgets to cap blast radius. Because Apps are rows rather than
